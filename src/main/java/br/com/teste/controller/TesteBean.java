...
public class TesteBean implements Serializable{
	...
	public TesteBean() {
		...
		listPaises.add("Bulg�ria");
		listPaises.add("B�lgica");
		listPaises.add("Argentina");
		listPaises.add("Canad�");
	...
	public void verificarLogin() {
		...
		if (login.equals("rodrigo")) {
			...
			Messages.addGlobalInfo("Login dispon�vel!");
		}
	}
